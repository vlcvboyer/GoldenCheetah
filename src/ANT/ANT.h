...
signals:
    ...
    void posData(uint16_t  posTime, uint8_t position);
...
public:
    ...
    void setLppb(uint8_t value) { telemetry.setLppb(value); }
    void setLppe(uint8_t value) { telemetry.setLppe(value); }
    void setLpppb(uint8_t value) { telemetry.setLpppb(value); }
    void setLpppe(uint8_t value) { telemetry.setLpppe(value); }
