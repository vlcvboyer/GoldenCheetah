                ...
                case POWER_CYCL_DYN_R_FORCE_ANGLE_PAGE:
                    {
                        ...
                        parent->setRppb(bradToDeg(antMessage.instantStartAngle));
                        parent->setRppe(bradToDeg(antMessage.instantEndAngle));
                        parent->setRpppb(bradToDeg(antMessage.instantStartPeakAngle));
                        parent->setRpppe(bradToDeg(antMessage.instantEndPeakAngle));
                ...
                case POWER_CYCL_DYN_L_FORCE_ANGLE_PAGE:
                    {
                        ...
                        // (note: conversion from binary radians to degres)
                        parent->setLppb(bradToDeg(antMessage.instantStartAngle));
                        parent->setLppe(bradToDeg(antMessage.instantEndAngle));
                        parent->setLpppb(bradToDeg(antMessage.instantStartPeakAngle));
                        parent->setLpppe(bradToDeg(antMessage.instantEndPeakAngle));
                        parent->setTorque(antMessage.torque*32);
