                ...
                case POWER_CYCL_DYN_L_FORCE_ANGLE_PAGE:
                    {
                        ...
                        // based on ANT+ Device Profile - Bicycle Power Rev 5.1 p.84 : 17.1 Right Force Angle (0xE0)
                        parent->setLppb(antMessage.instantStartAngle);      //Left Power Phase Begin
                        parent->setLppe(antMessage.instantEndAngle);        //Left Power Phase End
                        parent->setLpppb(antMessage.instantStartPeakAngle); //Left Power Phase Peak Begin
                        parent->setLpppe(antMessage.instantEndPeakAngle);   //Left Power Phase Peak End
                    }
                    break;
                ...
                case POWER_CYCL_DYN_PEDALPOSITION_PAGE:
                    {
                        ...
                        emit posData(0, antMessage.riderPosition);
                    }
                    break;
