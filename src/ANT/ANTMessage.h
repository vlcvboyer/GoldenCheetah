...
class ANTMessage {
    ...
    public:
        ...
        static ANTMessage enablePwrCapabilities1(const uint8_t channel, const uint8_t capabilities);
        static ANTMessage enablePwrCapabilities2(const uint8_t channel, const uint8_t capabilities);
        ...
        uint8_t instantStartAngle;
        uint8_t instantEndAngle;
        uint8_t instantStartPeakAngle;
        uint8_t instantEndPeakAngle;
