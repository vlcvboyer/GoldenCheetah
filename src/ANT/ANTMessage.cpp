                ...
                case POWER_GETSET_PARAM_PAGE:
                {
                    ...
                    switch(data_subpage) {
                        case POWER_ADV_CAPABILITIES1_SUBPAGE:
                            ...
                            qDebug()<<channel
                                << QString("Received power advanced capabilities page 1, pwrCapabilities1=0x")+QString("%1").arg(pwrCapabilities1, 2, 16, QChar('0')).toUpper()
                        ...
                        case POWER_ADV_CAPABILITIES2_SUBPAGE:
                            ...
                            qDebug()<<channel
                                << QString("Received power advanced capabilities page 2, pwrCapabilities2=0x")+QString("%1").arg(pwrCapabilities2, 2, 16, QChar('0')).toUpper()
...
{
    qDebug()<<channel<<"ANTMessage::requestPwrCapabilities1 Requesting Capabilities1";
...
{
    qDebug()<<channel<<"ANTMessage::requestPwrCapabilities2 Requesting Capabilities2";
...
ANTMessage ANTMessage::enablePwrCapabilities2(const uint8_t capabilities, const uint8_t channel)
{
    qDebug()<<channel<<"Sending ANT_POWER_ENABLE_CAPABILITES2_MESSAGE (Power)";
...
ANTMessage ANTMessage::enablePwrCapabilities1(const uint8_t capabilities, const uint8_t channel)
{
    qDebug()<<channel<<"Sending ANT_POWER_ENABLE_CAPABILITES1_MESSAGE (Power)";
